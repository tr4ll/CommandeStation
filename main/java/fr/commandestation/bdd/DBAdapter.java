...
public class DBAdapter {
	...
	public DBAdapter(Context context, String table, ArrayList<String> keys,
		...
		for (int i = 0; TABLE_KEYS.size() > i; i++) {
			...
			Log.i("DATABASE",TABLE_OPTIONS.toString());
			Log.i("DATABASE",TABLE_KEYS.toString());
	...
	public boolean removeEntry(String key,String value) {
		return db.delete(DATABASE_TABLE, key + "=" + "'"+value+"'", null) > 0;
	}
	/**
